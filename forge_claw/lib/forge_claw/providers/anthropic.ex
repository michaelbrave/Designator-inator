defmodule ForgeClaw.Providers.Anthropic do
  @moduledoc """
  ...
  API key is resolved via `ForgeClaw.Config.resolve_api_key/2` — never stored
  in pod directories.
  ...
  ForgeClaw uses short names like `"claude-sonnet"` in pod configs.
  ...
  ## Examples
      ...
      iex> ForgeClaw.Providers.Anthropic.complete(
      ...>   [
  ...
  def complete(messages, opts) do
    ...
    # 1. Resolve API key via ForgeClaw.Config.resolve_api_key(:anthropic, opts)
