defmodule ForgeClaw.ReActLoop do
  ...
  alias ForgeClaw.Types.{Message, ToolCall, ToolResult, ToolDefinition, ReActState}
  ...
  ## Examples
      ...
      iex> ForgeClaw.ReActLoop.run(messages, tools, executor, inference_fn, pod_name: "test")
      {:ok, "The answer is 42."}

      # Model called a tool that failed, then gave up after max_iterations
      iex> ForgeClaw.ReActLoop.run(messages, tools, executor, inference_fn,
  ...
  ## Examples
      ...
      iex> ForgeClaw.ReActLoop.step(state, tools, executor, inference_fn)
  ...
  ## Examples
      ...
      iex> ForgeClaw.ReActLoop.format_tools_prompt(
  ...
  ## Examples
      ...
      iex> ForgeClaw.ReActLoop.tool_result_to_message(
