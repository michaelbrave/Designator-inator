defmodule ForgeClaw.MCP.Transport.Stdio do
  @moduledoc """
  ...
  launches ForgeClaw as a subprocess via:
  ...
  The process:
  1. MCP client launches `forge serve ./my-pod/`
  2. ForgeClaw starts the application and this transport process
  ...
  alias ForgeClaw.MCP.{Protocol, Gateway}
  ...
  ## Examples
      ...
      iex> ForgeClaw.MCP.Transport.Stdio.read_message()
  ...
  ## Examples
      ...
      iex> ForgeClaw.MCP.Transport.Stdio.write_message(~s({"jsonrpc":"2.0","id":1,"result":{}}))
      :ok
  """
