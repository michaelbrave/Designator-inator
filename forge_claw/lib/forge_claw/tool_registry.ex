defmodule ForgeClaw.ToolRegistry do
  @moduledoc """
  ...
  @table_name :forge_claw_tool_registry
  ...
  ## Examples
      ...
      iex> ForgeClaw.ToolRegistry.lookup("review_code")
      [{"code-reviewer", #PID<0.456.0>, %ToolDefinition{name: "review_code", ...}}]

      iex> ForgeClaw.ToolRegistry.lookup("nonexistent_tool")
      []
  """
  ...
  ## Examples
      ...
      iex> ForgeClaw.ToolRegistry.list_all()
      [
  ...
  ## Examples
      ...
      iex> ForgeClaw.ToolRegistry.tools_for_pod("code-reviewer")
  ...
  @doc """
  Registers a pod's exposed tools.  Called by `ForgeClaw.Pod` on startup.
  ...
  ## Examples
      ...
      iex> ForgeClaw.ToolRegistry.register("assistant", self(), [
  ...
  ## Examples
      ...
      iex> ForgeClaw.ToolRegistry.deregister("assistant")
      :ok
  """
