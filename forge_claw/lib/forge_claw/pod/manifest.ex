defmodule ForgeClaw.Pod.Manifest do
  @moduledoc """
  ...
  Given a valid `manifest.yaml`:
      ...
      iex> ForgeClaw.Pod.Manifest.load("./my-pod/manifest.yaml")
      {:ok, %ForgeClaw.Types.PodManifest{name: "code-reviewer", ...}}

  Given an invalid manifest:

      iex> ForgeClaw.Pod.Manifest.load("./bad-pod/manifest.yaml")
      {:error, ["name is required", "exposed_tools must not be empty"]}
  """

  alias ForgeClaw.Types.{PodManifest, ResourceRequirements, ModelPreference, ToolDefinition}
  ...
  ## Examples
      ...
      iex> ForgeClaw.Pod.Manifest.load("/pods/assistant/manifest.yaml")
      {:ok, %ForgeClaw.Types.PodManifest{name: "assistant", version: "1.0.0", ...}}

      iex> ForgeClaw.Pod.Manifest.load("/pods/bad/manifest.yaml")
      {:error, ["name is required"]}

      iex> ForgeClaw.Pod.Manifest.load("/nonexistent/manifest.yaml")
      {:error, :enoent}
  """
  ...
  ## Examples
      ...
      iex> ForgeClaw.Pod.Manifest.parse(%{
      ...>   "name" => "assistant",
      ...>   "version" => "1.0.0",
      ...
      iex> ForgeClaw.Pod.Manifest.parse(%{"version" => "1.0.0"})
  ...
  ## Examples
      ...
      iex> ForgeClaw.Pod.Manifest.check_hardware(%PodManifest{
