defmodule ForgeClaw.ToolCallParserTest do
  @moduledoc """
  ...
  alias ForgeClaw.ToolCallParser
  alias ForgeClaw.ToolCallParser.{Llama3, ChatML}
  ...
  describe "ToolCallParser.parse/3" do
    ...
    test "accepts a module directly" do
      input = "<tool_call>\n{\"name\": \"foo\", \"arguments\": {}}\n</tool_call>"
      assert [%ToolCall{}] = ToolCallParser.parse(input, ForgeClaw.ToolCallParser.Llama3, "t1")
    end
  end
end
