defmodule DesignatorInator.Tool do
  @moduledoc """
  ...
  - `DesignatorInator.Tools.Workspace` — read/write/list files in the pod's workspace

  ## Adding a custom tool

  1. Create a module that `use DesignatorInator.Tool`
  ...
  See `DesignatorInator.Tools.Workspace` for the path traversal prevention pattern.
  """
  ...
  ## Examples
      ...
      iex> DesignatorInator.Tools.Workspace.name()
      "workspace"
  """
  ...
  ## Examples
      ...
      iex> DesignatorInator.Tools.Workspace.description()
  ...
  ## Examples
      ...
      iex> DesignatorInator.Tools.Workspace.parameters_schema()
      %{
  ...
  ## Examples
      ...
      iex> DesignatorInator.Tools.Workspace.call(%{"action" => "read", "path" => "notes.md"})
      {:ok, "# Notes\\nHello world"}

      iex> DesignatorInator.Tools.Workspace.call(%{"action" => "read", "path" => "../secret"})
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour DesignatorInator.Tool
    end
  end
end
