defmodule DesignatorInator.InferenceProvider do
  @moduledoc """
  ...
  1. `use DesignatorInator.InferenceProvider` (gets default implementations)
  ...
  All providers receive messages as `[DesignatorInator.Types.Message.t()]`.  Providers
  ...
  ## Examples
      ...
      DesignatorInator.Providers.LlamaCpp.stream(
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour DesignatorInator.InferenceProvider
