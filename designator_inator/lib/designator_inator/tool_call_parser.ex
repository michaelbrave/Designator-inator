defmodule DesignatorInator.ToolCallParser do
  @moduledoc """
  ...
  |--------------------------------------|---------------|------------------|
  | `DesignatorInator.ToolCallParser.Llama3`    | Llama3 / Meta | Llama 3.x, Mistral Nemo |
  | `DesignatorInator.ToolCallParser.ChatML`    | ChatML        | Mistral, Qwen, Phi-3 |
  ...
  The `ReActLoop` calls `DesignatorInator.ToolCallParser.parse/3` which dispatches to
  the right parser.  Unknown formats default to `Llama3`.

  ## Data definitions (HTDP step 1)

  Input: raw model response text (`String.t()`)
  Output: `[DesignatorInator.Types.ToolCall.t()]` — zero or more calls parsed out
  ...
  ## Examples
      ...
      iex> DesignatorInator.ToolCallParser.parse(
      ...>   "<tool_call>\\n{\\"name\\": \\"read_file\\", \\"arguments\\": {\\"path\\": \\"notes.md\\"}}\\n</tool_call>",
      ...>   :llama3,
      ...>   "c1"
      ...> )
      [%DesignatorInator.Types.ToolCall{id: "c1_0", name: "read_file", arguments: %{"path" => "notes.md"}}]

      iex> DesignatorInator.ToolCallParser.parse("The answer is 42.", :llama3, "c1")
      []
  """
  ...
  ## Examples
      ...
      iex> DesignatorInator.ToolCallParser.parse("...", :llama3, "turn_3")
      [%ToolCall{...}]
  """
  ...
  def resolve_parser(:llama3), do: DesignatorInator.ToolCallParser.Llama3
  def resolve_parser(:chatml), do: DesignatorInator.ToolCallParser.ChatML
  def resolve_parser(module) when is_atom(module), do: module
end

defmodule DesignatorInator.ToolCallParser.Llama3 do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> DesignatorInator.ToolCallParser.Llama3.parse(
      ...>   "<tool_call>\\n{\\"name\\": \\"list_files\\", \\"arguments\\": {}}\\n</tool_call>",
      ...>   "t1"
      ...> )
      [%DesignatorInator.Types.ToolCall{id: "t1_0", name: "list_files", arguments: %{}}]

      # No tool call — final answer
      iex> DesignatorInator.ToolCallParser.Llama3.parse("The files are: notes.md, plan.md", "t1")
      []

      # Malformed JSON inside tag — logged and skipped
      iex> DesignatorInator.ToolCallParser.Llama3.parse("<tool_call>not json</tool_call>", "t1")
      []
  """

  @behaviour DesignatorInator.ToolCallParser
...
defmodule DesignatorInator.ToolCallParser.ChatML do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> DesignatorInator.ToolCallParser.ChatML.parse(
      ...>   "<|tool_calls|>\\n[{\\"name\\": \\"read_file\\", \\"arguments\\": {\\"path\\": \\"f.md\\"}}]",
      ...>   "t1"
      ...> )
      [%DesignatorInator.Types.ToolCall{id: "t1_0", name: "read_file", arguments: %{"path" => "f.md"}}]
  """
