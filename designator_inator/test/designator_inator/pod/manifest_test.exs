defmodule DesignatorInator.Pod.ManifestTest do
  @moduledoc """
  Tests for `DesignatorInator.Pod.Manifest`.
  ...
  alias DesignatorInator.Types.{PodManifest, ResourceRequirements, ModelPreference}
