defmodule DesignatorInator.Test.Fixtures do
  @moduledoc """
  Shared test data for DesignatorInator unit and integration tests.
  ...
  @doc "Creates a temporary directory for the test."
  def tmp_dir(context) do
    dir = Path.join(System.tmp_dir!(), "designator_inator_test_#{context.test}")
    File.mkdir_p!(dir)
    dir
  end
end
